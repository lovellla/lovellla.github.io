...
$(document).ready(function(){
    ...
    $(".btn_box1 li.left").click(function(){
        clearInterval(intv1);
        prevSlideAni();
        intv1 = setInterval(function(){ nextSlideAni(); }, 5000);
    });
    $(".btn_box1 li.right").click(function(){
        clearInterval(intv1);
        nextSlideAni();
        intv1 = setInterval(function(){ nextSlideAni(); }, 5000);
    });
    ...
    $(".mtog_btn").click(
        ...
        $(".tog_gnb > li:not(:eq(0)) > a").click(function(){
        $(this).next().slideToggle(300);
        // $(this).next().slideDown(300);
        $(".tog_gnb > li:not(:eq(0)) > a").not(this).next().slideUp(300);
        return false;
        });
        $(".tog_gnb > li > a").eq(0).trigger("click");
        });
